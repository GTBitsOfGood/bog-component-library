...
/*!**********************************************************************************************!*\
  !*** ./node_modules/storybook-addon-designs/esm/register/components/Figspec.js + 35 modules ***!
  \**********************************************************************************************/
/*! exports provided: Figspec, default */
/*! all exports used */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/@emotion/core/dist/core.browser.esm.js */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/@storybook/components/dist/esm/placeholder/placeholder.js */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/react/index.js (<- Module is not an ECMAScript module) */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/storybook-addon-designs/esm/register/components/Figma.js */
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Figspec", function() { return /* binding */ Figspec; });
...
function internalProperty(options) {
    return decorators_property({ attribute: false, hasChanged: options === null || options === void 0 ? void 0 : options.hasChanged });
}
/**
 * Declares a private or protected property that still triggers updates to the
 * element when it changes.
...
const ErrorMessage = ({ title, children }) => lit_html_html `
 ...
 */
const styleMap = directive_directive((styleInfo) => (part) => {
...
`;
const HorizontalPaddingIcon = () => svg `
...
const View = ({ node, onClose }) => {
    ...
    >
      <div class="inspector-section selectable-content">
        ...
        ? lit_html_html `<p class="inspector-property">
                <span>Font:</span>
                ${nodeStyles.fontPostScriptName}
              </p>`
        : null}
      ...
      ${nodeStyles.hasPadding
        ? lit_html_html `<div class="inspector-section">
            <h4>Layout</h4>
...
const StylesSection = (nodeStyles) => {
    const onClick = () => copy_to_clipboard(nodeStyles.getStyleSheet());
    const styles = nodeStyles.getStyles();
    return lit_html_html `<div class="inspector-section">
...
const CSSProperty = (cssProperty) => {
    ...
    switch (property) {
        ...
        case "box-shadow":
        case "color":
            coloredSquare = lit_html_html `<span
        class="color-preview"
    ...
    return lit_html_html `<div class="css-property" @click=${() => copy_to_clipboard(getStyleRule(cssProperty))}>
 ...
 */
class FigspecFrameViewer_FigspecFrameViewer extends ViewerMixin(lit_element_LitElement) {
    constructor() {
        super(...arguments);
        /**
 ...
 * @fires nodeselect When a user selected / unselected a node.
 */
class FigspecFileViewer_FigspecFileViewer extends ViewerMixin(lit_element_LitElement) {
    constructor() {
        super(...arguments);
        /**
         * A response of "GET file nodes" API.
    ...
    render() {
      ...
      <div class="controls">
        <select @change=${FigspecFileViewer_classPrivateFieldGet(this, _handlePageChange)}>
          ${(_a = this.documentNode) === null || _a === void 0 ? void 0 : _a.document.children.map((c) => lit_html_html `<option value=${c.id}>${c.name}</option>`)}
        </select>
      </div>
...
const es2015_FigspecFrameViewer = Object(react["forwardRef"])((_a, ref) => {
    ...
    const [refNode, setNode] = Object(react["useState"])(null);
    Object(react["useImperativeHandle"])(ref, () => refNode, [refNode]);
    const refCb = Object(react["useCallback"])((node) => {
        if (node) {
            setNode(node);
            node.nodes = nodes;
    ...
    return (Object(react["createElement"])("figspec-frame-viewer", Object.assign({ ref: refCb, class: className, "pan-speed": panSpeed, "zoom-margin": zoomMargin, "zoom-speed": zoomSpeed }, rest)));
});
const es2015_FigspecFileViewer = Object(react["forwardRef"])((_a, ref) => {
    ...
    return (Object(react["createElement"])("figspec-file-viewer", Object.assign({ ref: refCb, class: className, "pan-speed": panSpeed, "zoom-margin": zoomMargin, "zoom-speed": zoomSpeed }, rest)));
});

// EXTERNAL MODULE: ./node_modules/@storybook/components/dist/esm/placeholder/placeholder.js
var placeholder = __webpack_require__("./node_modules/@storybook/components/dist/esm/placeholder/placeholder.js");
...
var fullscreen = Object(core_browser_esm["c" /* css */])(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n"])));
...
function getAccessToken(cfg) {
    ...
    try {
        return (_a = Object({"NODE_ENV":"development","NODE_PATH":[],"STORYBOOK":"true","PUBLIC_URL":"."}).STORYBOOK_FIGMA_ACCESS_TOKEN) !== null && _a !== void 0 ? _a : null;
    }
    catch (err) {
        return null;
    }
...
var Figspec = function (_a) {
    ...
    var fetchDetails = function (signal) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 6, , 7]);
                    match = config.url.match(Figma["b" /* figmaURLPattern */]);
                    if (!match) {
    ...
    switch (state.state) {
        case 'loading':
            return (Object(core_browser_esm["d" /* jsx */])(placeholder["a" /* Placeholder */], null,
                Object(core_browser_esm["d" /* jsx */])(react["Fragment"], null, "Loading Figma file...")));
        case 'failed':
            return (Object(core_browser_esm["d" /* jsx */])(placeholder["a" /* Placeholder */], null,
                Object(core_browser_esm["d" /* jsx */])(react["Fragment"], null, "Failed to load Figma file"),
                Object(core_browser_esm["d" /* jsx */])(react["Fragment"], null, state.error)));
        case 'fetched':
            return state.value.type === 'file' ? (Object(core_browser_esm["d" /* jsx */])(es2015_FigspecFileViewer, __assign({ css: fullscreen }, state.value.props))) : (Object(core_browser_esm["d" /* jsx */])(es2015_FigspecFrameViewer, __assign({ css: fullscreen }, state.value.props)));
    }
};
/* harmony default export */ var components_Figspec = __webpack_exports__["default"] = (Figspec);
